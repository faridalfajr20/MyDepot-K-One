...
public class Form_Edit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_namagalonman.setBounds(396, 631, 228, 47);
        ...
        jLabel_idgalonman.setBounds(396, 709, 228, 47);
        ...
        txt_namagalonman.setBounds(679, 635, 377, 40);
        ...
        btn_simpanperubahan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_simpanperubahanActionPerformed(evt);
            }
        });
        jPanel1.add(btn_simpanperubahan);
        btn_simpanperubahan.setBounds(1148, 869, 262, 96);
    ...
    private void btn_batalkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_batalkanActionPerformed
        ...
        int response = JOptionPane.showConfirmDialog(null, "Yakin ingin Membatalkan  ?", "BATALKAN", JOptionPane.YES_NO_OPTION);
    ...
    private void btn_simpanperubahanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanperubahanActionPerformed
        // TODO add your handling code here:
        controllerM.Kirim();
        
    }//GEN-LAST:event_btn_simpanperubahanActionPerformed
